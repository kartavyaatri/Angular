...
<body>
    <?php
        ...
        ?>
            ...
            <input type="submit" name="submit" value="Login" style="width: 200px; height: 30px;" />
            <br><br>
        </form>
        ...
        if(isset($_POST['submit']))
        {
          ...
          try{
             ...
             $stmt = "SELECT username,password FROM users where username='$name' and password='$pass'";
             $result = $conn->query($stmt);
             if ($result->rowCount() > 0)
             {
                    ?>
                    <form action='Calc.php' method='post' name='frm'>
